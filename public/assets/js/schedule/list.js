...
var KTCustomersList = function () {
    var t, e, o, n, c = () => {
        n.querySelectorAll('[data-kt-coupon-table-filter="delete_row"]').forEach((e => {
            let button = e;
            e.addEventListener("click", (function (e) {
                ...
                Swal.fire({
                    text: "¿Está seguro de eliminar el horario " + n + "?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    ...
                    e.value ? (
                        //console.log(button.attributes[2].value),
                        $.ajax({
                            url: '/dashboard/schedule/destroy/'+button.attributes[2].value,
                            method: 'POST',
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: JSON.stringify({ schedule_id: button.attributes[2].value }),
                            processData:false,
                            contentType:'application/json; charset=utf-8',
                            success: function (data) {
                                console.log(data);
                                Swal.fire({
                                    text: "Has eliminado el horario de " + n + "!.",
                                    icon: "success",
                                    buttonsStyling: !1,
                        ...
                        text: "El horario " + n + " no fue eliminado.",
                        icon: "error",
                        buttonsStyling: !1,
