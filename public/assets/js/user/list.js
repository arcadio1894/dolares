...
var KTUsersPermissionsList = function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_users_table")) && (e.querySelectorAll("tbody tr").forEach((t => {
            ...
            }), document.querySelector('[data-kt-users-table-filter="search"]').addEventListener("keyup", (function (e) {
