    ...
    var t, e, o, n, c = () => {
        n.querySelectorAll('[data-kt-coupon-table-filter="delete_row"]').forEach((e => {
            ...
            e.addEventListener("click", (function (e) {
                ...
                Swal.fire({
                    text: "¿Está seguro de eliminar el cupón " + n + "?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    ...
                    e.value ? (
                        //console.log(button.attributes[2].value),
                        $.ajax({
                            url: '/dashboard/coupon/destroy/'+button.attributes[2].value,
                            method: 'POST',
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: JSON.stringify({ coupon_id: button.attributes[2].value }),
                            processData:false,
                            contentType:'application/json; charset=utf-8',
                            success: function (data) {
                                console.log(data);
                                Swal.fire({
                                    text: "Has eliminado el cupón " + n + "!.",
                                    icon: "success",
                                    buttonsStyling: !1,
