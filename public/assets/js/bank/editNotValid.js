...
var KTModalCustomersEdit = function () {
    ...
    return {
        init: function () {
            i = new bootstrap.Modal(document.querySelector("#kt_modal_edit_customer")), r = document.querySelector("#kt_modal_edit_customer_form"), t = r.querySelector("#kt_modal_edit_customer_submit"), e = r.querySelector("#kt_modal_edit_customer_cancel"), o = r.querySelector("#kt_modal_edit_customer_close"), n = FormValidation.formValidation(r, {
                fields: {
