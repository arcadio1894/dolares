...
@section('content')
    <div class="row">
        ...
        <div class="card card-flush h-md-100">
            <form id="kt_create_role_form" class="form-horizontal" data-kt-action="{{ route('roles.store') }}" enctype="multipart/form-data" data-kt-redirect="{{ route('roles.index') }}">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-solid" placeholder="Ingrese un código del rol" name="role_name" />
                        ...
                        <div class="col-sm-6">
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-solid" placeholder="Ingrese una descripción" name="role_description" />
