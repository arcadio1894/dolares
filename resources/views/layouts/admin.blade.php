        ...
        <div id="kt_aside" class="aside aside-extended" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
            ...
            <div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
                ...
                <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
                    <a href="{{ route('home') }}">
                        <img alt="Logo" src="{{ asset('assets/media/logos/logo-demo7.png') }}" class="h-35px" />
                    </a>
                </div>
                <!--end::Logo-->
                <!--begin::Nav-->
                    ...
                    <div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('dashboard.profile') }}" class="menu-link px-5">Mi perfil</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            {{--<div class="menu-item px-5">
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('logout') }}"
                                   onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="menu-link px-5">Cerrar sesión</a>
                                                ...
                                                <a href="{{ route('home') }}" class="text-primary custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="symbol symbol-40px me-5">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('assets/media/icons/duotune/finance/fin007.svg') }}" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Description-->
                                ...
                                <div class="tab-pane fade @yield('activeTabGraphs')" id="kt_aside_nav_tab_graphs" role="tabpanel">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="mb-10">
                                                <!--begin::Item-->
                                                {{--<a href="{{ route('home') }}" class="custom-list d-flex align-items-center px-5 py-4">
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-40px me-5">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('assets/media/icons/duotune/finance/fin007.svg') }}" class="h-50 align-self-center" alt="" />
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold text-gray-800 mb-1">Calculadora</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                ...
                                                <a href="{{ route('dashboard.graphs.Kambista') }}" class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold @yield('activeGraphKambista', 'text-gray-800') mb-1">Gráficos Kambista</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                        <span class="text-gray-400 fw-bold">En tiempo real</span>
                                                        <!--end::Link-->
                                                ...
                                                <a href="{{ route('dashboard.graphs.Bloomberg') }}" class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="symbol symbol-40px me-5">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('assets/media/icons/duotune/graphs/gra001.svg') }}" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Description-->
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold @yield('activeGraphBloomberg', 'text-gray-800') mb-1">Gráficos Bloomberg</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                        <span class="text-gray-400 fw-bold">En tiempo real</span>
                                                        <!--end::Link-->
                                                ...
                                                <a href="{{ route('dashboard.graphs.Google') }}" class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="symbol symbol-40px me-5">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('assets/media/icons/duotune/graphs/gra002.svg') }}" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Description-->
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold @yield('activeGraphGoogle', 'text-gray-800') mb-1">Gráficos Google</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                        <span class="text-gray-400 fw-bold">En tiempo real</span>
                                                        <!--end::Link-->
                                                ...
                                                <a href="{{ route('dashboard.graphs.Cocosylucas') }}" class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="symbol symbol-40px me-5">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('assets/media/icons/duotune/graphs/gra003.svg') }}" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Description-->
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold @yield('activeGraphCocosylucas', 'text-gray-800') mb-1">Gráficos Cocosylucas</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                        <span class="text-gray-400 fw-bold">En tiempo real</span>
                                                        <!--end::Link-->
                                                ...
                                                <a href="{{ route('dashboard.graphs.TKambio') }}" class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="symbol symbol-40px me-5">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('assets/media/icons/duotune/graphs/gra004.svg') }}" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Description-->
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold @yield('activeGraphTKambio', 'text-gray-800') mb-1">Gráficos TKambio</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                        <span class="text-gray-400 fw-bold">En tiempo real</span>
                                                        <!--end::Link-->
                                                ...
                                                <a href="{{ route('dashboard.graphs.SecuEx') }}" class="custom-list d-flex align-items-center px-5 py-4">
                                                    ...
                                                    <div class="symbol symbol-40px me-5">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('assets/media/icons/duotune/graphs/gra005.svg') }}" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Description-->
                                                    <div class="d-flex flex-column flex-grow-1">
                                                        <!--begin::Title-->
                                                        <h5 class="custom-list-title fw-bold @yield('activeGraphSecuEx', 'text-gray-800') mb-1">Gráficos SecuEx</h5>
                                                        <!--end::Title-->
                                                        <!--begin::Link-->
                                                        <span class="text-gray-400 fw-bold">En tiempo real</span>
                                                        <!--end::Link-->
                                        ...
                                        <div id="kt_aside_menu_wrapper" class="menu-fit">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionAccounts') {{--show--}}">
                                                <span class="menu-link @yield('activeMenuAccordionAccounts') {{--active--}}">
                                                    ...
                                                    <span class="menu-title">Cuentas de Dolareros</span>
                                                    <span class="menu-arrow"></span>
                                                </span>
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    <div class="menu-item">
                                                        <a class="menu-link @yield('activeMenuAccountList')" href="{{ route('accounts.dolareros.index') }}">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionBanks') {{--show--}}">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    <div class="menu-item">
                                                        <a class="menu-link @yield('activeMenuBankList')" href="{{ route('banks.index') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionSources') {{--show--}}">
                                                <span class="menu-link @yield('activeMenuAccordionSources') {{--active--}}">
                                                    ...
                                                    <span class="menu-title">Origen de Fondos</span>
                                                    <span class="menu-arrow"></span>
                                                </span>
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    <div class="menu-item">
                                                        <a class="menu-link @yield('activeMenuSourceList')" href="{{ route('sourceFunds.index') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Listado de orígenes</span>
                                                        </a>
                                                    </div>
                                                    {{--<div class="menu-item">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionOperations') {{--show--}}">
                                                <span class="menu-link @yield('activeMenuAccordionOperations') {{--active--}}">
                                                    ...
                                                    <span class="menu-title">Gestor de operaciones</span>
                                                    <span class="menu-arrow"></span>
                                                </span>
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    <div class="menu-item">
                                                        <a class="menu-link @yield('activeMenuOperationList')" href="{{ route('operation.dolareros.index') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Listado de operaciones</span>
                                                        </a>
                                                    </div>
                                                    {{--<div class="menu-item">
                                                        <a class="menu-link @yield('activeMenuBankCreate')" href="#">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionVerificationUsers') {{--show--}}">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    <div class="menu-item">
                                                        <a class="menu-link @yield('activeMenuVerificationUserList')" href="{{ route('verification.images.users') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Usuarios No verificados</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endcan
                                            @can('enable_coupons')
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionCouponsUsers') {{--show--}}">
                                                    <span class="menu-link @yield('activeMenuAccordionCouponsUsers') {{--active--}}">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                                            <span class="svg-icon svg-icon-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                        <div class="menu-item">
                                                            <a class="menu-link @yield('activeMenuCouponList')" href="{{ route('coupon.index') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            @endcan
                                            @can('enable_informations')
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionInformations') {{--show--}}">
                                                    <span class="menu-link @yield('activeMenuAccordionInformations') {{--active--}}">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                                            <span class="svg-icon svg-icon-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                        <div class="menu-item">
                                                            <a class="menu-link @yield('activeMenuInformationList')" href="{{ route('information.index') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                                <span class="menu-title">Listado de noticias</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endcan
                                            @can('enable_schedule')
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionSchedule') {{--show--}}">
                                                    <span class="menu-link @yield('activeMenuAccordionSchedule') {{--active--}}">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                                            <span class="svg-icon svg-icon-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                        ...
                                                        <span class="menu-title">Horario de Atención</span>
                                                        <span class="menu-arrow"></span>
                                                    </span>
                                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                        <div class="menu-item">
                                                            <a class="menu-link @yield('activeMenuSchedule')" href="{{ route('schedule.index') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                                <span class="menu-title">Configurar horario</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endcan
                                            @can('enable_typeExchange')
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionTypeExchange') {{--show--}}">
                                                    <span class="menu-link @yield('activeMenuAccordionTypeExchange') {{--active--}}">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                                            <span class="svg-icon svg-icon-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                        ...
                                                        <span class="menu-title">Tipo de cambio</span>
                                                        <span class="menu-arrow"></span>
                                                    </span>
                                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                        <div class="menu-item">
                                                            ...
                                                            <span class="menu-bullet">
                                                                ...
                                                                <span class="menu-title">Configurar manualmente</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endcan
                                            @can('enable_typeExchange')
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('showMenuAccordionAccounting') {{--show--}}">
                                                    <span class="menu-link @yield('activeMenuAccordionAccounting') {{--active--}}">
                                                        <span class="menu-icon">
                                                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                                            <span class="svg-icon svg-icon-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                        ...
                                                        <span class="menu-title">Mod. Contabilidad</span>
                                                        <span class="menu-arrow"></span>
                                                    </span>
                                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                        <div class="menu-item">
                                                            <a class="menu-link @yield('activeMenuAccounting')" href="{{ route('accounting.index') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
            ...
            <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                ...
                <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                    ...
                    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                        <!--begin::Heading-->
                        <h1 class="text-dark fw-bolder my-0 fs-2">@yield('page-title')</h1>
                        <!--end::Heading-->
                        <!--begin::Breadcrumb-->
                        @yield('breadcrumb')
                    ...
                    <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                        ...
                        <a href="{{ route('home') }}" class="d-flex align-items-center">
                            <img alt="Logo" src="{{ asset('assets/media/logos/logo-demo7.png') }}" class="h-30px" />
                        </a>
                        <!--end::Logo-->
                    </div>
                    <!--end::Wrapper-->
                    ...
                    <div class="mh-300px scroll-y me-n7 pe-7">
                        ...
                        <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Details-->
                                <div class="ms-5">
                                    <a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">{{ Auth::user()->first_name }}</a>
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="{{ asset('assets/media/illustrations/sigma-1/9.png') }}" alt="" class="w-100 mh-300px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
