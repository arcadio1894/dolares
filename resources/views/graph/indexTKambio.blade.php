...
@section('breadcrumb')
    <ul class="breadcrumb fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">Gráficos TKambio</li>
    </ul>
@endsection

@section('activeTabPanelGraphs', 'active')
@section('activeTabGraphs', 'active show')
@section('activeGraphTKambio', 'text-primary')
            ...
            <div class="card card-xl-stretch mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Tipo de cambio en TKambio</span>
                        <span class="text-muted fw-bold fs-7">Actualizado cada 1 minuto</span>
                    </h3>
                    <!--begin::Toolbar-->
                    <div class="card-toolbar" data-kt-buttons="true">

                        <select id="statusTKambio" name="status" data-control="select2" data-hide-search="true" class="form-select form-select-sm form-select-white w-100px">
                ...
                <div class="card-body">
                    <!--begin::Chart-->
                    <div id="chartTKambio" style="height: 300px"></div>
                    <!--end::Chart-->
                </div>
                <!--end::Body-->
            </div>
...
@section('scripts')
    <script src="{{ asset('assets/js/graph/indexTKambio.js') }}"></script>
@endsection
