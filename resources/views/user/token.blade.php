...
@section('page-title', 'Contraseña segura')
...
@section('breadcrumb')
    <ul class="breadcrumb fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">Token Secreto</li>
    </ul>
@endsection

@section('activeTabProfile', 'active show')
@section('activeProfileToken', 'text-primary')
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}</a>
                                <a href="#">
                    ...
                    @else
                        <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                            ...
                            <span class="svg-icon svg-icon-2tx svg-icon-success me-4">
                                <img width="30px" src="{{ asset('assets/media/icons/duotune/general/gen048.svg') }}" class="h-50 align-self-center" alt="" />
